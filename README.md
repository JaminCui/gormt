...
or: [Dowloading](https://github.com/JaminCui/gormt/releases)
...
- Support function export (foreign key, association, index , unique and more)[Support export function >>>](https://github.com/JaminCui/gormt/blob/master/data/view/genfunc/genfunc_test.go)
...
### [more>>>](https://github.com/JaminCui/gormt/tree/master/doc/func.md)
### [how to use call style>>>](https://github.com/JaminCui/gormt/blob/master/data/view/genfunc/genfunc_test.go)
...
[Download](https://github.com/JaminCui/gormt/releases/download/v0.3.8/v1.0.zip)
